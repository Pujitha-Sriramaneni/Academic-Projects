 ...
 * @author Sneha
 */
public class NorthAmericaJPanel extends javax.swing.JPanel {
    
    JPanel userProcessContainer;
    Enterprise enterprise;
    /**
     * Creates new form NorthAmericaJPanel
     */
    UserDetailIO udio = new UserDetailIO();
    public NorthAmericaJPanel(JPanel userProcessContainer, Enterprise enterprise,UserDetailIO udio) {
        initComponents();
    ...
    private void initComponents() {
        ...
        NaCountryJComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose your country", "USA", "Canada", "Mexico" }));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(country.equals("Choose your country")){
            ...
            MilitaryJPanel weapon = new MilitaryJPanel(userProcessContainer, enterprise, country,udio);
