 ...
 * @author Sneha
 */
public class AsiaJPanel extends javax.swing.JPanel {
    
    JPanel userProcessContainer;
    Enterprise enterprise;
    /**
     * Creates new form AsiaJPanel
     */
    public AsiaJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to Asia");

        NaCountryJComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose your country", "India", "Russia", "China" }));
