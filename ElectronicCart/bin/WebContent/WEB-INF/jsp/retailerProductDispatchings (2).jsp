...
<title>Retailer - Dispatch Products</title>
</head>
<body>
	<form:form name="dispatchOrderForm" action="dispatchOrder.html"
		method="post">
					...
					<c:forEach var="custCart" items="${customerCarts}">
						<tr>
							...
							<th><button id="${custCart.customerCartId}"
									...
									onclick='dispatchProducts(this)' style="color: purple;">Dispatch
									Order</button></th>
						</tr>
					</c:forEach>
				</tbody>
	...
	<script type="text/javascript">
		function dispatchProducts(userValue) {
