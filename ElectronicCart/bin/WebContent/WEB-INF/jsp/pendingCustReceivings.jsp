...
<body>
	<form:form name="initmateCustReceiveForm"
		action="custReceiveMessageDispatchIntimation.html" method="post">
						...
						<tr>
							...
							<th>
								<button id="${custCart.customerCartId}"
									...
									onclick='messageFuncReceive(this)' style="color: purple;">Message</button>
							</th>
						</tr>
					</c:forEach>
				</tbody>
	...
	<script type="text/javascript">
		function messageFuncReceive(userValue) {
