...
<title>Customer - Cancel Orders</title>
</head>
<body>
	<form:form name="cancelOrderForm" action="cancelOrder.html"
		method="post">
				...
				<tbody>
					<c:forEach var="custCart" items="${customerCarts}">
						<tr>
							...
							<th><button id="${custCart.customerCartId}"
									value="${custCart.customerCartId}" onclick='cancelFunc(this)'
									style="color: purple;">Cancel</button></th>
						</tr>
					</c:forEach>
				</tbody>
			</table>
