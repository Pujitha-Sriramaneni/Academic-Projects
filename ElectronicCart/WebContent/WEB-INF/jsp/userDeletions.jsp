...
<title>Electronic Cart - Admin Deletions</title>
</head>
<body>
	<form:form id="submitForm" action="deleteUsers.html" method="post">
					...
					<c:forEach var="user" items="${userDetails}">
						<tr>
							...
							<th><button id="${user.loginUserName}"
									...
									onclick='adminDeletions(this)'>Delete</button></th>
						</tr>
					</c:forEach>
				</tbody>
			</table>
...
<script type="text/javascript">
	function adminDeletions(userValue) {
		var tempValue = userValue.value;
		document.getElementById("userSelection").value = tempValue + "~Delete";
	}
</script>
</html>