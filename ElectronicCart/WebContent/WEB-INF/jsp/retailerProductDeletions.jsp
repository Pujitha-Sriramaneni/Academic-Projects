...
<title>Retailer - Remove from Shop</title>
</head>
<body>
	<form:form name="deleteRetailerProduct" action="deleteRetailerProduct.html"
		method="post">
					...
					<c:forEach var="prd" items="${retailerProducts}">
						<tr>
							...
							<th><button id="${prd.rtlPrdId}" value="${prd.rtlPrdId}"
									onclick='deleteFromShop(this)'>Remove From Shop</button></th>
						</tr>
					</c:forEach>
				</tbody>
			</table>
	...
	<script type="text/javascript">
		function deleteFromShop(userValue) {
